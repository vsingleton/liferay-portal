...
package com.liferay.workspaceTestSite.struts;
 ...
 */
public class TestSiteStrutsAction extends BaseStrutsAction {
	...
	public String execute(
		...
		try {
			...
			Layout layout = LayoutLocalServiceUtil.addLayout(
				...
				LayoutConstants.DEFAULT_PARENT_LAYOUT_ID, "TestSiteAction",
	...
	private User _getUser(HttpServletRequest request) throws Exception {
		...
		try {
			return UserLocalServiceUtil.getUserByScreenName(companyId, "testSite");
		}
		catch (Exception e) {
			...
			String screenName = "testSite";
			String emailAddress = "testSite@liferay.com";
			long facebookId = 0;
			String openId = StringPool.BLANK;
			Locale locale = LocaleUtil.US;
			String firstName = "TestSite";
			...
			UserLocalServiceUtil.updateReminderQuery(userId, "TestSite", "TestSite");
