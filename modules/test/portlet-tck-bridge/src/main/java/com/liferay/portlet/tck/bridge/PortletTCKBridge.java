...
public class PortletTCKBridge {
	...
	private void _waitForDeployment(
		...
		while ((System.currentTimeMillis() - startTime) < timeout) {
			...
			if (servletContext != null) {
				...
				_log.warn(
					"_waitForDeployment: BEAN_PORTLET_IDS = " +
						servletContext.getAttribute(WebKeys.BEAN_PORTLET_IDS));
				_log.warn(
					"_waitForDeployment: PLUGIN_PORTLETS = " +
						servletContext.getAttribute(WebKeys.PLUGIN_PORTLETS));
			}

			_log.warn("_waitForDeployment: 1 found = " + found);
			...
			Object pluginThemes = servletContext.getAttribute(
